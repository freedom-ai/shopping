...
function is_registered( username )
{
    ...
    Ajax.call( 'http://www.xianxiu.com/js/user.php?act=is_registered', 'username=' + username, registed_callback , 'GET', 'TEXT', true, true );
}
...
function checkEmail(email)
{
  ...
  Ajax.call( 'http://www.xianxiu.com/js/user.php?act=check_email', 'email=' + email, check_email_callback , 'GET', 'TEXT', true, true );
}
